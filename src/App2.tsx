    ...
    return (
      <div>
        <Modal
          ...
          contentLabel="Error"
        >
          <h2 ref={(subtitle) => { this.subtitle = subtitle; return subtitle; }}>Error</h2>
        ...
        <form>
          ...
          >
            <div style={{ gridColumn: '1', gridRow: '1' }}>
              ...
              <div>
                <fieldset {...this.state.enabled ? {} : { disabled: 'disabled' }}>
            ...
            <div style={{ gridColumn: '1', gridRow: '2' }}>{this.state.component}</div>
          </div>
        </form>
      </div>
    );
